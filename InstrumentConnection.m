...
% PT-BR instructions O que fazer:
    ...
    % instalado antes de conectar o USB/GPIB ao computador. Na instalação
    % também tem-se a interface Keysight Connection Expert, que é capaz de
    ...
    %Links: Read me da instalação <goo.gl/rxZlDy>
    % Instalação <goo.gl/g6IoD4>

    % Fonte operando em SCPI: Para verificar, pressionar o botão LCL até
    % aparecer o endereço do instrumento "Adr --". No caso de apenas o
    % endereço primário aparecer, a fonte está no modo compatibilidade
    % (ARPS). Caso apareça "SEC --", a fonte está no modo SCPI e pode ser
    % conectada com o Matlab. A alteração da linguagem de COMP para SCPI
